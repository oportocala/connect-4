...
class Player extends React.Component {
    ...
    render () {
        return (<div className={"player-avatar "+ this.props.className}>
                <div className="image">
                    <svg version="1.1"
                         xmlns="http://www.w3.org/2000/svg"
                         x="0px" y="0px"
                         viewBox="0 0 61.7 67.4"
                         enable-background="new 0 0 61.7 67.4"
                         width="60"
                         height="60">
                        <path className={this.props.className} d="M38.2,47.8c-0.7-0.9-1.1-2.1-1.1-3.4c0-0.6,0.1-1.2,0.2-1.7c3.5-2.8,6.3-7.8,7.6-14c0.1,0,0.1,0,0.2,0
